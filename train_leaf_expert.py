...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a third-level leaf expert for one middle group.")
...
def main() -> None:
    ...
    run_name = datetime.now().strftime(f"leaf_expert_{args.subgroup}_{args.backbone}_%Y%m%d_%H%M%S")
