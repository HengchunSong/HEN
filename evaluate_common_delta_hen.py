...
from hen import HierarchySpec, JointHierManifestDataset, build_common_delta_hen, build_transforms


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a common-delta shared-backbone HEN run.")
    parser.add_argument("--run-dir", type=Path, required=True)
    parser.add_argument("--data-root", type=Path, default=None)
    parser.add_argument("--output-path", type=Path, default=ROOT / "outputs" / "common_delta_hen_eval_summary.json")
