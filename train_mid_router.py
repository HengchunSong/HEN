...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a second-level router inside one top-level branch.")
...
def main() -> None:
    ...
    run_name = datetime.now().strftime(f"mid_router_{args.group}_{args.backbone}_%Y%m%d_%H%M%S")
