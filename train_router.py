...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the top-level router on the ImageNet 27-class subtree.")
...
def main() -> None:
    ...
    run_name = datetime.now().strftime(f"router_{args.backbone}_%Y%m%d_%H%M%S")
